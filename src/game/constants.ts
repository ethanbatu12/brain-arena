...
export const GRID_START = 3; // starting board size

// How long the pattern is shown. Bigger boards reveal longer (more to memorize).
export const MEMORIZE_MS_SMALL = 3000; // small boards
export const MEMORIZE_MS_LARGE = 4000; // boards from MEMORIZE_LARGE_FROM and up
export const MEMORIZE_LARGE_FROM = 5; // 5×5 and larger get the longer reveal
...
export const BASE_POINTS = 10; // multiplier for the per-round score curve

/** Fraction of the board that lights up. Higher = harder. */
export const FILL_RATIO = 0.35;
